...
class EditNewForm extends StatefulWidget {
  final String productId; // Firestore document ID to edit

  const EditNewForm({Key? key, required this.productId}) : super(key: key);

  @override
  State<EditNewForm> createState() => _EditNewFormState();
}
